<?php if (!defined('__TYPECHO_ROOT_DIR__')) exit; ?>
	...
	<footer class="footer">
		<div class="container">
			...
			<div class="row">
				...
				<div class="col-md-4 widget">
					<h5>近期归档</h5>
					<ul><?php $this->widget('Widget_Contents_Post_Date', 'limit=6&type=month&format=Y年m月')->parse('<li><a href="{permalink}" class="footer-link">{date}</a></li>'); ?></ul>
				</div>
			</div>
			<hr/>
			<?php } ?>
			<div class="row">
				...
				<div class="col-md-6">
					<ul class="nav nav-footer justify-content-end">
						...
						<?php else: ?>
							<li class="nav-item"><a class="nav-link" href="/member.php">登录</a></li>
						<?php endif; ?>
					</ul>
				</div>
			</div>
	...
	<script src="<?php $this->options->themeUrl("assets/js/co_render.js"); ?>"></script>
	<!-- scrollup -->
	<script>
		$(function(){
...
<script type="text/javascript" src="\usr\themes\Cocowolf\assets\js\Cocowolf.js"></script>
	<!-- Prism JS -->
	...
	!function (e, t, a) {
		function r() {
			for (var e = 0; e < s.length; e++) s[e].alpha <= 0 ? (t.body.removeChild(s[e].el), s.splice(e, 1)) : (s[e].y--, s[e].scale += .004, s[e].alpha -= .013, s[e].el.style.cssText = "left:" + s[e].x + "px;top:" + s[e].y + "px;opacity:" + s[e].alpha + ";transform:scale(" + s[e].scale + "," + s[e].scale + ") rotate(45deg);color:" + s[e].color + ";z-index:999999");
		...
		e.requestAnimationFrame = e.requestAnimationFrame || e.webkitRequestAnimationFrame || e.mozRequestAnimationFrame || e.oRequestAnimationFrame || e.msRequestAnimationFrame || function (e) {
			setTimeout(e, 1e3 / 60)
		}, i(".fa-paw{width: 15px;height: 15px;position: fixed;}"), n(), r()
	}(window, document);
    </script>
	<!-- Typecho footer -->
	<?php $this->footer(); ?>
