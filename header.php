...
<head>
	...
	<meta itemprop="name" content="<?php $this->archiveTitle(array(
		...
		$this->options->title();
		if ($this->is('index') && $this->options->subtitle != '') echo "- {$this->options->subtitle}";
	?> | Furry Friendly Place Project">
    <meta itemprop="image" content="https://furion.6lnc.cn/usr/themes/Cocowolf/images/avatar.png"><!-- 图片 -->
    <meta name="description" itemprop="description" content="<?php $this->excerpt(100, '...'); ?>">
					...
					<div class="navbar-collapse-header">
						<div class="row">
							<div class="col-6 collapse-brand">
								<a href="<?php $this->options->siteUrl(); ?>"><h5>站点导航</h5></a>
							</div>
						...
						<li class="navbar_search_container">
							<form method="post" action="" id="search">
								<div class="input-group input-group-alternative">
									...
									<input type="text" name="s" class="form-control" placeholder="想了解点什么?" type="text" autocomplete="off">
								</div>
							</form>
						</li>
					</ul>
